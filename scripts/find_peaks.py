...
def detect_eeg_peaks(signals, start_minute=0, duration_minutes=1):
    def trim_signal(signal, sampling_frequency, start_minute, duration_minutes):
        start_index = start_minute * 60 * sampling_frequency
        end_index = (start_minute + duration_minutes) * 60 * sampling_frequency
